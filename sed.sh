...
echo "setup remote..."
git remote add main git@gitlab.com:bimaguava/"$x".git
git remote add origin https://gitlab.com/bimaguava/"$x"
echo "[OK]"
...
if [ $isInFile -eq 0 ]; then
   cd ../../../../
   git submodule add git@gitlab.com:bimaguava/"$x".git source/space/Import/"$x"
